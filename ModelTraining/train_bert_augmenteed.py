...
df = pd.read_csv("augmented_malaysian_news.csv")
...
model.save_pretrained("bert_malaysian_news_model_augmented")
tokenizer.save_pretrained("bert_malaysian_news_model_augmented")
